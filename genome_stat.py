...
required.add_argument('name',help='help')
#name = sys.argv[1]
...
print(f'{args.name}\t{seqs_sum}\t{base_sum}\t{round(100 * GC_sum / base_sum, 2)}', file = None)
#print(f'Total base (bp)\t{base_sum}', file = None)
...
#print(f'GC (%)\t{round(100 * GC_sum / base_sum, 2)}', file = None)
